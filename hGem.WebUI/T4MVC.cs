...
{
    public static hGem.WebUI.Controllers.AccountController Account = new hGem.WebUI.Controllers.T4MVC_AccountController();
    public static hGem.WebUI.Controllers.AuthenticationController Authentication = new hGem.WebUI.Controllers.T4MVC_AuthenticationController();
    public static hGem.WebUI.Controllers.ClientController Client = new hGem.WebUI.Controllers.T4MVC_ClientController();
    public static hGem.WebUI.Controllers.DashboardControlsController DashboardControls = new hGem.WebUI.Controllers.T4MVC_DashboardControlsController();
    public static hGem.WebUI.Controllers.HomeController Home = new hGem.WebUI.Controllers.T4MVC_HomeController();
    public static hGem.WebUI.Controllers.TextResourceController TextResource = new hGem.WebUI.Controllers.T4MVC_TextResourceController();
    public static hGem.WebUI.Controllers.UserController User = new hGem.WebUI.Controllers.T4MVC_UserController();
