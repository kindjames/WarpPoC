...
using hGem.WebUI.ViewModels.Client;
...
namespace hGem.WebUI.Controllers
{
    ...
    public partial class ClientController : Controller
    {
        ...
        public ClientController(IClientService clientService, IObjectMapper objectMapper, IUniqueIdentifierGenerator uniqueIdentifierGenerator)
        {
        ...
        public virtual ActionResult Create(CreateClientViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                dto.Id = _uniqueIdentifierGenerator.GenerateNewId();
