...
namespace Warp.WebUI.Controllers
{
    ...
    public partial class T4MVC_AuthenticationController : Warp.WebUI.Controllers.AuthenticationController
    {
        ...
        [NonAction]
        partial void LoginOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, hGem.WebUI.ViewModels.Authentication.LoginViewModel model, string returnUrl);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> Login(hGem.WebUI.ViewModels.Authentication.LoginViewModel model, string returnUrl)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Login);
