...
namespace Warp.Testing.Integration.WebUI.Util
{
    public abstract class WebDriverResultSupplementer : ISupplementSpecificationResults
    {
        ...
        private void CaptureScreenshot(IDictionary<string, string> supplement, string screenshotPath)
        {
            try
            {
        ...
        private void CaptureHtmlSource(IDictionary<string, string> supplement, string htmlPath)
        {
            try
            {
        ...
        private static void Report(Exception error, string type, IDictionary<string, string> supplement)
        {
