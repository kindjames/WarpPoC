...
{
    public class ApplicationUserStore : IUserStore<ApplicationUser, int>, IUserPasswordStore<ApplicationUser, int> //IUserRoleStore<ApplicationUser, int>, IUserPasswordStore<ApplicationUser, int>//, IUserLockoutStore<ApplicationUser, int>, IUserSecurityStampStore<ApplicationUser, int>,
    {
        ...
        //public Task<DateTimeOffset> GetLockoutEndDateAsync(ApplicationUser appUser)
        //{
        //    throw new NotImplementedException();
        //}

        //public Task SetLockoutEndDateAsync(ApplicationUser appUser, DateTimeOffset lockoutEnd)
        //{
        //    throw new NotImplementedException();
        //}

        //public Task<int> IncrementAccessFailedCountAsync(ApplicationUser appUser)
        //{
        //    throw new NotImplementedException();
        //}

        //public Task ResetAccessFailedCountAsync(ApplicationUser appUser)
        //{
        //    throw new NotImplementedException();
        //}

        //public Task<int> GetAccessFailedCountAsync(ApplicationUser appUser)
        //{
        //    throw new NotImplementedException();
        //}

        //public Task<bool> GetLockoutEnabledAsync(ApplicationUser appUser)
        //{
        //    throw new NotImplementedException();
        //}

        //public Task SetLockoutEnabledAsync(ApplicationUser appUser, bool enabled)
        //{
        //    throw new NotImplementedException();
        //}
